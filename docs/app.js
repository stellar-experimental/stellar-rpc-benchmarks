...
(function () {
  ...
  function renderSynthetic(D) {
    ...
    if (showMem) (function fig21() {
      ...
      legend("fig21-legend", [
        { label: "cold backfill", color: C.s1 }, { label: "hot ingest", color: C.hot },
